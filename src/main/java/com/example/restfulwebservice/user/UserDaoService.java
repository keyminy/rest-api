...
public class UserDaoService {
    ...
    static {
        users.add(new User( 1, "mike", new Date(),"pass1","701010-1111111"));
        users.add(new User( 2, "jacob", new Date(),"pass2","801010-1111111"));
        users.add(new User( 3, "smith", new Date(),"pass3","901010-11111111"));
    }
    //사용자 전체 목록 전달하는 메소드
    ...
    public User deleteById(int id){
        ...
        while(ite.hasNext()){
            ...
            if(user.getId()==id){
                ...
                return user; //user가 지워진것을 알 수 있게
            }
        }
